...
public class DeezerTestController {
    ...
    private final DeezerCuratorService deezerService;

    public DeezerTestController(DeezerCuratorService deezerService) {
    ...
    public ResponseEntity<Map<String, Object>> testDeezer() {
        try {
            MusicTrackDto song = deezerService.getFamousSong();
    ...
    public ResponseEntity<Map<String, Object>> testItalian() {
        try {
            MusicTrackDto song = deezerService.getItalianSong();
    ...
    public ResponseEntity<Map<String, Object>> testInternational() {
        try {
            MusicTrackDto song = deezerService.getInternationalSong();
